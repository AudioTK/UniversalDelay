...
DefaultGroupName=UniversalDelay
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=UniversalDelay Installer
...
[Files]
Source: "..\Builds\VisualStudio2019_32\Win32\Release\VST3\UniversalDelay.vst3"; DestDir: "{cf}\VST3\"; Check: not Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2019_32\Win32\Release\VST3\UniversalDelay.vst3"; DestDir: "{cf32}\VST3\"; Check: Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2019\x64\Release\VST3\UniversalDelay.vst3"; DestDir: "{cf64}\VST3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion;

;Source: "..\Builds\VisualStudio2019_32\Win32\Release\aax\UniversalDelay.aaxplugin\*.*"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\UniversalDelay.aaxplugin\"; Components:aax_32; Flags: ignoreversion recursesubdirs;
;Source: "..\Builds\VisualStudio2019\x64\Release\aax\UniversalDelay.aaxplugin\*.*"; DestDir: "{cf}\Avid\Audio\Plug-Ins\UniversalDelay_x64.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;

Source: "..\manual\UniversalDelay_manual.pdf"; DestDir: "{app}"
Source: "changelog.txt"; DestDir: "{app}"
Source: "readmewin.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
Name: "{group}\UniversalDelay"; Filename: "{app}\UniversalDelay.exe"
Name: "{group}\User guide"; Filename: "{app}\UniversalDelay_manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
Name: "{group}\Uninstall UniversalDelay"; Filename: "{app}\unins000.exe"
